...
- **O1 (IA):** Construir y comparar detectores supervisados y no supervisados.
- **O2 (Big Data):** Pipeline reproducible y trazable con el dataset completo.
- **O3 (Ciberseguridad):** Evaluar robustez ante evasión y explicabilidad (SHAP).
